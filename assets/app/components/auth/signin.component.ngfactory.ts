...
class _View_SigninComponent0 extends import1.AppView<import3.SigninComponent> {
  ...
  createInternal(rootSelector:string):import2.AppElement {
    ...
    this._text_21 = this.renderer.createText(this._el_20,'Login',(null as any));
...
export function viewFactory_SigninComponent0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<import3.SigninComponent> {
  if ((renderType_SigninComponent === (null as any))) { (renderType_SigninComponent = viewUtils.createRenderComponentType('C:/Users/ahooshmand/Projects/MEAN/SmarGrid2/assets/app/components/auth/signin.component.html',0,import10.ViewEncapsulation.None,styles_SigninComponent,{})); }
