...
function viewFactory_AuthComponent_Host0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<any> {
  if ((renderType_AuthComponent_Host === (null as any))) { (renderType_AuthComponent_Host = viewUtils.createRenderComponentType('',0,import9.ViewEncapsulation.None,[],{})); }
  return new _View_AuthComponent_Host0(viewUtils,parentInjector,declarationEl);
}
export const AuthComponentNgFactory:import10.ComponentFactory<import3.AuthComponent> = new import10.ComponentFactory<import3.AuthComponent>('app-auth',viewFactory_AuthComponent_Host0,import3.AuthComponent);
const styles_AuthComponent:any[] = ['.nav[_ngcontent-%COMP%] {\n            margin-bottom:20px;\n        }'];
...
class _View_AuthComponent0 extends import1.AppView<import3.AuthComponent> {
  ...
  createInternal(rootSelector:string):import2.AppElement {
    ...
    this._TemplateRef_11_5 = new import20.TemplateRef_(this._appEl_11,viewFactory_AuthComponent1);
    ...
    this._TemplateRef_13_5 = new import20.TemplateRef_(this._appEl_13,viewFactory_AuthComponent2);
...
export function viewFactory_AuthComponent0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<import3.AuthComponent> {
  if ((renderType_AuthComponent === (null as any))) { (renderType_AuthComponent = viewUtils.createRenderComponentType('C:/Users/ahooshmand/Projects/MEAN/SmarGrid2/assets/app/components/auth/auth.component.ts class AuthComponent - inline template',0,import9.ViewEncapsulation.Emulated,styles_AuthComponent,{})); }
...
class _View_AuthComponent2 extends import1.AppView<any> {
  _el_0:any;
  _RouterLinkActive_0_3:import11.RouterLinkActive;
  _query_RouterLink_0_0:import12.QueryList<any>;
  _query_RouterLinkWithHref_0_1:import12.QueryList<any>;
  ...
  /*private*/ _expr_3:any;
  constructor(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement) {
    super(_View_AuthComponent2,renderType_AuthComponent,import6.ViewType.EMBEDDED,viewUtils,parentInjector,declarationEl,import7.ChangeDetectorStatus.CheckAlways);
  }
  createInternal(rootSelector:string):import2.AppElement {
    this._el_0 = this.renderer.createElement((null as any),'li',(null as any));
    this.renderer.setElementAttribute(this._el_0,'routerLinkActive','active');
...
function viewFactory_AuthComponent2(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<any> {
  return new _View_AuthComponent2(viewUtils,parentInjector,declarationEl);
}