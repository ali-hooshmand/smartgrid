...
class _View_SignupComponent0 extends import1.AppView<import3.SignupComponent> {
  ...
  createInternal(rootSelector:string):import2.AppElement {
    ...
    this.renderer.setElementAttribute(this._el_14,'for','lasttName');
    ...
    this.renderer.setElementAttribute(this._el_17,'id','lasttName');
...
export function viewFactory_SignupComponent0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<import3.SignupComponent> {
  if ((renderType_SignupComponent === (null as any))) { (renderType_SignupComponent = viewUtils.createRenderComponentType('C:/Users/ahooshmand/Projects/MEAN/SmarGrid2/assets/app/components/auth/signup.component.html',0,import9.ViewEncapsulation.None,styles_SignupComponent,{})); }
