...
import * as import31 from './components/error/error.service';
import * as import32 from './components/auth/auth.service';
import * as import33 from '@angular/core/src/di/injector';
import * as import34 from './components/article/articlelist/article-list.component.ngfactory';
import * as import35 from './components/about/about.component.ngfactory';
import * as import36 from './components/auth/auth.component.ngfactory';
import * as import37 from './components/auth/signup.component.ngfactory';
import * as import38 from './components/auth/signin.component.ngfactory';
import * as import39 from './components/auth/logout.component.ngfactory';
import * as import40 from './components/article/articleinput/article-input.component.ngfactory';
import * as import41 from './components/article/articledetails/article-details.component.ngfactory';
...
import * as import50 from './components/article/articlelist/article-list.component';
import * as import51 from './components/about/about.component';
import * as import52 from './components/auth/auth.component';
import * as import53 from './components/auth/signup.component';
import * as import54 from './components/auth/signin.component';
import * as import55 from './components/auth/logout.component';
import * as import56 from './components/article/articleinput/article-input.component';
import * as import57 from './components/article/articledetails/article-details.component';
import * as import58 from './models/article.model';
...
class AppModuleInjector extends import0.NgModuleInjector<import1.AppModule> {
  ...
  _FormsModule_8:import8.FormsModule;
  ...
  __Http_39:any;
  __FormBuilder_40:import25.FormBuilder;
  ...
  constructor(parent:import33.Injector) {
    super(parent,[
      import34.ArticleListComponentNgFactory,
      import35.AboutComponentNgFactory,
      import36.AuthComponentNgFactory,
      import37.SignupComponentNgFactory,
      import38.SigninComponentNgFactory,
      import39.LogoutComponentNgFactory,
      import40.ArticleInputComponentNgFactory,
      import41.ArticleDetailsComponentNgFactory,
  ...
  get _BrowserXhr_34():import21.BrowserXhr {
    if ((this.__BrowserXhr_34 == (null as any))) { (this.__BrowserXhr_34 = new import21.BrowserXhr()); }
    return this.__BrowserXhr_34;
  }
  get _ResponseOptions_35():import22.BaseResponseOptions {
    if ((this.__ResponseOptions_35 == (null as any))) { (this.__ResponseOptions_35 = new import22.BaseResponseOptions()); }
  ...
  get _XHRBackend_37():import23.XHRBackend {
    if ((this.__XHRBackend_37 == (null as any))) { (this.__XHRBackend_37 = new import23.XHRBackend(this._BrowserXhr_34,this._ResponseOptions_35,this._XSRFStrategy_36)); }
    return this.__XHRBackend_37;
  }
  get _RequestOptions_38():import24.BaseRequestOptions {
    if ((this.__RequestOptions_38 == (null as any))) { (this.__RequestOptions_38 = new import24.BaseRequestOptions()); }
  ...
  get _FormBuilder_40():import25.FormBuilder {
    if ((this.__FormBuilder_40 == (null as any))) { (this.__FormBuilder_40 = new import25.FormBuilder()); }
  ...
  get _LocationStrategy_43():any {
    if ((this.__LocationStrategy_43 == (null as any))) { (this.__LocationStrategy_43 = import6.provideLocationStrategy(this.parent.get(import48.PlatformLocation),this.parent.get(import49.APP_BASE_HREF,(null as any)),this._ROUTER_CONFIGURATION_42)); }
  ...
  get _ROUTES_48():any[] {
      if ((this.__ROUTES_48 == (null as any))) { (this.__ROUTES_48 = [[
        {
          path: 'home',
          component: import50.ArticleListComponent
        }
        ,
        {
          path: 'about',
        ...
        {
          path: 'auth',
          component: import52.AuthComponent,
          children: [
            {
              path: '',
              redirectTo: 'signin',
        ...
        {
          path: 'article-input',
          component: import56.ArticleInputComponent
        }
        ,
        {
          path: 'article/:id',
          component: import57.ArticleDetailsComponent,
          data: [import58.Article]
        }
        ,
        {
          path: '',
  ...
  get _Router_49():any {
    if ((this.__Router_49 == (null as any))) { (this.__Router_49 = import6.setupRouter(this._ApplicationRef_16,this._UrlSerializer_45,this._RouterOutletMap_46,this._Location_44,this,this._NgModuleFactoryLoader_47,this._Compiler_17,this._ROUTES_48,this._ROUTER_CONFIGURATION_42)); }
    return this.__Router_49;
  }
  get _ActivatedRoute_50():any {
    if ((this.__ActivatedRoute_50 == (null as any))) { (this.__ActivatedRoute_50 = import6.rootRoute(this._Router_49)); }
    return this.__ActivatedRoute_50;
  }
  get _APP_BOOTSTRAP_LISTENER_51():any[] {
    if ((this.__APP_BOOTSTRAP_LISTENER_51 == (null as any))) { (this.__APP_BOOTSTRAP_LISTENER_51 = [import6.initialRouterNavigation(this._Router_49,this._ROUTER_CONFIGURATION_42)]); }
  ...
  get _AuthService_53():import32.AuthService {
    if ((this.__AuthService_53 == (null as any))) { (this.__AuthService_53 = new import32.AuthService(this._Http_39,this._ErrorService_52)); }
  ...
  createInternal():import1.AppModule {
    ...
    this._ROUTER_FORROOT_GUARD_4 = import6.provideForRootGuard(this.parent.get(import59.Router,(null as any)));
    ...
    this._FormsModule_8 = new import8.FormsModule();
    ...
    this._ApplicationRef__15 = new import12.ApplicationRef_(this.parent.get(import46.NgZone),this.parent.get(import60.Console),this,this._ErrorHandler_12,this,this._ApplicationInitStatus_13,this.parent.get(import11.TestabilityRegistry,(null as any)),this._Testability_14);
  ...
  getInternal(token:any,notFoundResult:any):any {
    ...
    if ((token === import8.FormsModule)) { return this._FormsModule_8; }
    ...
    if ((token === import69.XSRFStrategy)) { return this._XSRFStrategy_36; }
    if ((token === import23.XHRBackend)) { return this._XHRBackend_37; }
    if ((token === import24.RequestOptions)) { return this._RequestOptions_38; }
    if ((token === import70.Http)) { return this._Http_39; }
    if ((token === import25.FormBuilder)) { return this._FormBuilder_40; }
